...
public class GraphQLConfiguration {
    ...
    public Resource graphQLSchema() {
        ...
        log.debug("Auto-generated graphql schema:\n{}", printedSchema);
    ...
    public GraphQLSchema generateSchema() {
        ...
        String pkgName = GraphQLConfiguration.class.getPackageName().substring(0,
                GraphQLConfiguration.class.getPackageName().lastIndexOf("."));
        ...
        getPackageClasses(pkgName).filter(this::classIsComponentAnotated)
                ...
                .filter(m -> m.isAnnotationPresent(QueryMapping.class)).forEach(method -> {
                    log.debug("Including {} : {}", method.getDeclaringClass().getName(), method.getName());
